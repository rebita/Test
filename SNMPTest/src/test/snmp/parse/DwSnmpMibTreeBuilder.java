...
//		JTree newTree=null;
	...
	private void loadFile(String fileName) {
		System.out.print("Adding file " + fileName);
		if(parseFile(fileName)<0) System.out.println(".. Error");
	...
	private void  updateOrphans() {
		...
		System.out.println("Updating orphans.");
		...
		System.out.println("Updating variables table..");
