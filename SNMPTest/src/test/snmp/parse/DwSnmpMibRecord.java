...
public class DwSnmpMibRecord implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 2114285753117667666L;
	...
	/*
	 * recordType = recNormal/recVariable/recTable(1,2,3) During parsing, it is
	 * always kept -1 ,1 or 0.
	 * 
	 * This is used during tree generation... During parsing, recordType is
	 * always kept 0 for simplification reason recordType = 1 => it is ITSELF a
	 * table (i.e. its syntax is a Sequence) = 2 => it is a entry (elements
	 * under "Entry" are actual elements = 3 => it is an element. Index values
	 * are appended to it instead of .0 = 0 => The entry is not in any
	 * table,i.e. it is a normal record :)
	 * 
	 * Variable tableEntry is used to store the no. of entries the table
	 * contains,i.e. number of values for each element of table. -1 means it has
